...
// MIDDLEWARE -
// Middleware can be very useful for doing validations. We can log things from here or stop the request from continuing in the event that the request is not safe.
